...
<body class="bg-gray">
        ...
        <div class="content-container">
            ...
            <div class="support-option payment-option option-box clearfix">
                <a href="primary.do" class="option active">1차 목표가</a>
            ...
            <div class="content-box">
                <span class="title">1차 목표가 확인 상품 횟수제</span>
                <div class="primary-goal-items">
                    <div class="item">
                        <div class="img-holder-box">
                            <span class="img-holder"><img src="/img/ticket-1.png" alt=""></span>
                        </div>
                        <div class="ticket txt-bold">
                            <span>1회 이용권</span> 
                        </div>
                        <a href="#" class="btn-price">9,000 원</a>
                    </div>
                    <div class="item">
                        <div class="img-holder-box">
                            <span class="img-holder"><img src="/img/ticket-5.png" alt=""></span>
                        </div>
                        <div class="ticket txt-bold">
                            <span>5회 이용권</span> 
                        </div>
                    ...
                    <div class="item">
                        <div class="img-holder-box">
                            <span class="img-holder"><img src="/img/ticket-10.png" alt=""></span>
                        </div>
                        <div class="ticket txt-bold">
                            <span>10회 이용권</span> 
                        </div>
                        <a href="#" class="btn-price">39,000 원</a>
                    </div>
                </div>
                <div class="divider"></div>
                <span class="title">1차 목표가 확인 상품 기간제</span>
                <div class="primary-goal-items">
                    <div class="item">
                        <div class="img-holder-box">
                            <span class="img-holder"><img src="/img/ticket-gold-1.png" alt=""></span>
                        </div>
                        <div class="ticket txt-bold">
                            <span>1개월 이용권</span> 
                        </div>
                    ...
                    <div class="item">
                        <div class="img-holder-box">
                            <span class="img-holder"><img src="/img/ticket-gold-3.png" alt=""></span>
                        </div>
                        <div class="ticket txt-bold">
                            <span>3개월 이용권</span> 
                        </div>
                        <a href="#" class="btn-price">199,000 원</a>
                    </div>
                    <div class="item">
                        <div class="img-holder-box">
                            <span class="img-holder"><img src="/img/ticket-gold-6.png" alt=""></span>
                        </div>
                        <div class="ticket txt-bold">
                            <span>6개월 이용권</span> 
                        </div>
                        <a href="#" class="btn-price">299,000 원</a>
                    </div>
                    <div class="item">
                        <div class="img-holder-box">
                            <span class="img-holder"><img src="/img/ticket-gold-12.png" alt=""></span>
                        </div>
                        <div class="ticket txt-bold">
                            <span>12개월 이용권</span> 
                        </div>
                        <a href="#" class="btn-price">399,000 원</a>
                    </div>
                </div>
            </div>
        </div>
