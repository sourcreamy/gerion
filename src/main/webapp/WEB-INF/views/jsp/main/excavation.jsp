...
<body class="bg-gray">
        ...
        <div class="content-container">
            ...
            <div class="support-option payment-option option-box clearfix">
                ...
                <a href="excavation.do" class="option active"> 발굴 알고리즘</a>
            ...
            <div class="content-box">
                <span class="title">종목발굴 알고리즘 상품 기간제</span>
                <div class="primary-goal-items">
                    <div class="item">
                        <div class="img-holder-box">
                            <span class="img-holder"><img src="/img/ticket-ea-1.png" alt=""></span>
                        </div>
                    ...
                    <div class="item">
                        <div class="img-holder-box">
                            <span class="img-holder"><img src="/img/ticket-ea-3.png" alt=""></span>
                        </div>
                        <div class="ticket txt-bold">
                            <span>3회 이용권</span> 
                        </div>
                    ...
                    <div class="item">
                        <div class="img-holder-box">
                            <span class="img-holder"><img src="/img/ticket-ea-6.png" alt=""></span>
                        </div>
                        <div class="ticket txt-bold">
                            <span>6회 이용권</span> 
                        </div>
                    ...
                    <div class="item">
                        <div class="img-holder-box">
                            <span class="img-holder"><img src="/img/ticket-ea-12.png" alt=""></span>
                        </div>
                        <div class="ticket txt-bold">
                            <span>12 이용권</span> 
                        </div>
                        <a href="#" class="btn-price">499,000 원</a>
                    </div>
                </div>
            </div>
        </div>
