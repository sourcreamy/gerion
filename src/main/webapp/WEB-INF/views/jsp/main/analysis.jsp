    ...
    <body class="bg-gray">
        ...
        <div class="content-container">
            ...
            <div class="support-option payment-option option-box clearfix">
                ...
                <a href="analysis.do" class="option active">프리미엄분석</a>
            ...
            <div class="content-box">
                <span class="title">프리미엄 종목 분석 상품 기간제</span>
                <div class="primary-goal-items">
                    <div class="item">
                        <div class="img-holder-box">
                            <span class="img-holder"><img src="/img/ticket-pa-1.png" alt=""></span>
                        </div>
                    ...
                    <div class="item">
                        <div class="img-holder-box">
                            <span class="img-holder"><img src="/img/ticket-pa-3.png" alt=""></span>
                        </div>
                        <div class="ticket txt-bold">
                            <span>3개월 이용권</span> 
                        </div>
                    ...
                    <div class="item">
                        <div class="img-holder-box">
                            <span class="img-holder"><img src="/img/ticket-pa-6.png" alt=""></span>
                        </div>
                        <div class="ticket txt-bold">
                            <span>6개월 이용권</span> 
                        </div>
                    ...
                    <div class="item">
                        <div class="img-holder-box">
                            <span class="img-holder"><img src="/img/ticket-pa-12.png" alt=""></span>
                        </div>
                        <div class="ticket txt-bold">
                            <span>12개월 이용권</span> 
                        </div>
